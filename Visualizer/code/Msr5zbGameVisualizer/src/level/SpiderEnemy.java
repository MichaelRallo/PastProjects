...
public class SpiderEnemy extends Thread 
{
    ...
    public SpiderEnemy(AnchorPane anchorPane, Double xPosn) 
    {   
        //Set Pane
        ...
        //Create Enemy
        Rectangle newMissle = new Rectangle(30, 30);
        missle = newMissle;
        missle.setTranslateX(xPosn);
        missle.setTranslateY(5);
        
        //Fill Enemy With Image
        String imageURL = Msr5zbGameVisualizer.class.getResource("images/spider.gif").toExternalForm();
