...
public class BonesEnemy extends Thread {
    ...
    public BonesEnemy(AnchorPane anchorPane, Double xPosn) 
    {
        //Set Pane
        ...
        String imageURL = Msr5zbGameVisualizer.class.getResource("images/skull.gif").toExternalForm();
