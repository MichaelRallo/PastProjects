...
public class AsteroidMissle extends Thread {
    ...
    private Long sleepTime = 6L;
    public Bounds bounds = null;
    public boolean paused = false;
    
    
    public AsteroidMissle(AnchorPane anchorPane, Double xPosn, Double yPosn) 
    {
        //Set Pane/Positions
