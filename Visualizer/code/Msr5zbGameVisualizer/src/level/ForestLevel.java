...
public class ForestLevel implements LevelStandards {
    ...
    private ArrayList<SpiderMissle> missles;
    
    private int enemyCounter= 0;
    private ArrayList<SpiderEnemy> enemies;
    ...
    public void pause()
    {
           ...
           for (SpiderMissle missle : missles) 
           {                  
               missle.paused = true;
           } 
    }
    ...
    public void start(Integer numBands, AnchorPane vizPane) 
    {
        ...
        //Background Image
        String image = Msr5zbGameVisualizer.class.getResource("images/forest2.gif").toExternalForm();
        try
        {
    ...
    public void update(double timestamp, double duration, float[] magnitudes, float[] phases) 
    {
        ...
        if(sec%5 == 0 && enemyCounter < 7)
        {
            ...
            SpiderEnemy enemy = new SpiderEnemy(vizPane, (double)randomNum); 
            enemies.add(enemy);
            enemy.start();
            enemyCounter++;
        }
        ...
        {   System.out.println("W is being Pressed!");
            SpiderMissle missle = new SpiderMissle(vizPane, playerRectangle.getTranslateX(), playerRectangle.getTranslateY()); 
            missles.add(missle);
            missle.start();
            missleCount++;              
        }
        ...
        {   
            if(missle != null && missle.stop ==false)
            {
                ...
                //Check To See If Missles Hit An Enermy!
                for(SpiderEnemy enemy : enemies) 
                {  
